import { TextureLoader,MeshStandardMaterial,Color,Object3D, Vector4, Vector3, MathUtils, Quaternion, Matrix3, InstancedBufferGeometry, InstancedBufferAttribute, DynamicDrawUsage, Uniform, Vector2, ShaderMaterial, AdditiveBlending, Mesh, DoubleSide, FrontSide, PlaneBufferGeometry, Matrix4, NormalBlending, DefaultLoadingManager, LoaderUtils, FileLoader, LoadingManager, ImageLoader, CubeTexture, Texture, Group, UVMapping, CubeReflectionMapping, CubeRefractionMapping, EquirectangularReflectionMapping, EquirectangularRefractionMapping, CubeUVReflectionMapping, CubeUVRefractionMapping, RepeatWrapping, ClampToEdgeWrapping, MirroredRepeatWrapping, NearestFilter, NearestMipMapNearestFilter, NearestMipMapLinearFilter, LinearFilter, LinearMipMapNearestFilter, LinearMipMapLinearFilter } from 'three';
...
class MuzzleFlashDemo {
    ...
    initScene(tmpScene) {
        ...
        this.texture = new TextureLoader().load(baseUrl+"smoke.png", (texture) => {
            console.log("loaded");
            this.texture.name = baseUrl+"smoke.png";
        ...
        this.texture2 = new TextureLoader().load(baseUrl+"fire1.png", (texture) => {
            console.log("loaded");
            this.texture2.name = baseUrl+"fire1.png";
            this.textureLoadCount++;
        ...
        this.texture3 = new TextureLoader().load(baseUrl+"fire2.png", (texture) => {
            console.log("loaded");
            this.texture3.name = baseUrl+"fire2.png";
            this.textureLoadCount++;
...
export default () => {
    ...
    useFrame(({timestamp}) => {
        ...
        if (localPlayer) {
			//app.position.set(localPlayer.position.x, localPlayer.position.y - 1.4, localPlayer.position.z);
			demo.setPosition(new Vector3(localPlayer.position.x, localPlayer.position.y - 1.4, localPlayer.position.z));
